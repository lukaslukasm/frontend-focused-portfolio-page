        ...
        <Dialog.Portal>
          ...
          >
            <Dialog.Content className="focus-visible:custom-focus-visible bg-bg col mx-4 my-4 flex h-[150svh] w-full max-w-[60rem] rounded-xl p-4 pt-4 sm:my-12 sm:rounded-3xl sm:p-12 sm:pt-6">
              <Dialog.Close className="bg-highlight text-bg/70 hover:text-bg focus-visible:custom-focus-visible sticky top-4 cursor-pointer self-end rounded-full p-1.5 transition-colors sm:top-6 sm:-mr-6">
                <svg
